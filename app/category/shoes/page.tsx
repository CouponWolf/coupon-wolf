...
export default function ShoesPage() {
  ...
  const loadCover = (brand: string) => {
    ...
    if (brand === "Others") {
      setCoverSrc("/shoes-covers/other_shoe.png");
      return;
    }

    const formatted = brand.toLowerCase().replace(/\s+/g, "-");

    const img = new Image();
    const path = `/shoes-covers/${formatted}_shoe.png`;
  ...
  return (
    <div className="clothing-page">
      ...
      <img src="/categories/shoes.png" className="category-icon" />

      <h1 className="clothing-title">SHOES</h1>
