...
export default function TechPage() {
  ...
  const loadCover = (brand: string) => {
    ...
    if (brand === "Others") {
      setCoverSrc("/tech-covers/othertech_cover.png");
      return;
    }
    ...
    const img = new Image();
    const path = `/tech-covers/${formatted}_cover.png`;
  ...
  return (
    <div className="clothing-page">
      ...
      <img src="/categories/tech.png" className="category-icon" />

      <h1 className="clothing-title">TECH</h1>
